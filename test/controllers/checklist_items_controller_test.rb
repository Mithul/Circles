...
class ChecklistItemsControllerTest < ActionController::TestCase
  ...
  test "should create checklist_item" do
    assert_difference('ChecklistItem.count') do
      post :create, checklist_item: { checked: @checklist_item.checked, checklist_id: @checklist_item.checklist_id, title: @checklist_item.title }
    end
  ...
  test "should update checklist_item" do
    patch :update, id: @checklist_item, checklist_item: { checked: @checklist_item.checked, checklist_id: @checklist_item.checklist_id, title: @checklist_item.title }
    assert_redirected_to checklist_item_path(assigns(:checklist_item))
  end
