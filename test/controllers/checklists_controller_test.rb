...
class ChecklistsControllerTest < ActionController::TestCase
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post :create, checklist: { circle_id: @checklist.circle_id, title: @checklist.title, user_id: @checklist.user_id }
    end
  ...
  test "should update checklist" do
    patch :update, id: @checklist, checklist: { circle_id: @checklist.circle_id, title: @checklist.title, user_id: @checklist.user_id }
    assert_redirected_to checklist_path(assigns(:checklist))
  end
