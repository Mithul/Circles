    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
                ...
                $.each(element.data, function (i, entry) {
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        entries.push(
                            ...
                            '<span class="fn-label' +
                            (entry.cssClass ? ' ' + entry.cssClass+'-gantt' : 'defaul-gantt') + '" data-id='+(entry.id ? ' ' + entry.id : null)+'>' +
                            (entry.name || '') +
                            '</span>' +
                            '</div>');
            ...
            createProgressBar: function (days, label, desc, classNames, dataObj) {
                ...
                var bar = $('<div class="bar"><div class="fn-label" data-id="1">' + label + '</div></div>')
                        .css({
                    ...
                    if (i >= element.pageNum * settings.itemsPerPage &&
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            case "hours":
                                ...
                                _bar = core.createProgressBar(dl, day.label, day.desc, day.customClass, day);
